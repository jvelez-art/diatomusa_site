export const tagline = "Sutil elegancia en tu ritual diario";

export const amazonUrl = "https://www.amazon.es/s?k=diatomusa";
...
export const trustBadges = ["Prime", "Garantía 12m", "Atención local"];
